...
HD_PWD='D:/CODES/vivado/Project3-1/Project3-1.runs/design_1_andgate_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_andgate_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_andgate_0_1.tcl
