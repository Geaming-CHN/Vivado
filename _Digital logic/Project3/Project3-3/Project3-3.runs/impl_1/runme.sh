...
HD_PWD='D:/CODES/vivado/Project3-3/Project3-3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_1.tcl -notrace
