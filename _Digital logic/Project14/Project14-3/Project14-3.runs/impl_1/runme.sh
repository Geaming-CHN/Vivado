...
HD_PWD='D:/CODES/vivado/Project14-3/Project14-3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FIFO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_FIFO.tcl -notrace
