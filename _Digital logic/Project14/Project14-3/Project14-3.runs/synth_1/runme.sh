...
HD_PWD='D:/CODES/vivado/Project14-3/Project14-3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_FIFO.tcl
