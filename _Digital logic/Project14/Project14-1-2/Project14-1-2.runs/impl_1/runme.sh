...
HD_PWD='C:/Users/lenovo/Desktop/Project14/Project14-1-2/Project14-1-2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Asy_SinglePortRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Asy_SinglePortRAM.tcl -notrace
