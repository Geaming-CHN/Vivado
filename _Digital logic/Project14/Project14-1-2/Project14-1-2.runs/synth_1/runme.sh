...
HD_PWD='C:/Users/lenovo/Desktop/Project14/Project14-1-2/Project14-1-2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Asy_SinglePortRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Asy_SinglePortRAM.tcl
