...
HD_PWD='C:/Users/lenovo/Desktop/Project14/Project14-1-1/Project-14-1-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Syn_SinglePortRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Syn_SinglePortRAM.tcl -notrace
