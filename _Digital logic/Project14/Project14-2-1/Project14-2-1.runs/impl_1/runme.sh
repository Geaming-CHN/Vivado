...
HD_PWD='C:/Users/lenovo/Desktop/Project14/Project14-2-1/Project14-2-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Syn_DoublePortRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Syn_DoublePortRAM.tcl -notrace
